...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-emerald-600 to-green-800 text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="bg-emerald-100 p-4 rounded-full w-20 h-20 mx-auto mb-4 
  group-hover:bg-emerald-200 transition-colors">
  <TruckIcon className="h-12 w-12 text-emerald-600" />
</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <Link to="/books" className="inline-flex items-center text-emerald-600 
  hover:text-emerald-700 font-semibold text-lg group">
              ดูหนังสือทั้งหมด
